...
<section id="facts" class="facts ">
  <div class="container-fluid">
   ...
   <div class="row clearfix form-inline d-flex justify-content-center form-inline" id="showbl{{$tc->id_post}}">
  ...
  $(document).ready(function() {
    $('.binhluan').each(function(index, binhluanBtn){
      $(binhluanBtn).click(function(event) {
        ...
        // hien thi binh luan co id_cha la null
        ...
        $.get('/api/binhluan/'+idPost, function(data) 
        {
          ...
          {
            ht+='<img src="'+v.images+'" alt="" class="media  rounded-circle mr-2   " style="width:50px;height:50px" >'+
            ' <input type="text" class="form-control col-lg-11 mb-2 hienthibl" disabled value="'+v.content+'">';
